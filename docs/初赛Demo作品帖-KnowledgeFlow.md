...
> **【标签】** `学习工作`
>
> **【标题】** 学习工作 | KnowledgeFlow — AI 智能体驱动的学习平台
...
> 【截图位 1，落地页首页】
> 建议截图，访问首页，展示 Hero 区「让知识轻松流入你的脑海」与金黑配色设计
>
> 【截图位 2，智能学习页 - AI 讲解】
> 建议截图，进入「智能学习」页，输入「递归」，展示 AI 七步讲解的完整输出
>
> 【截图位 3，学习计划页 - 知识路线】
> 建议截图，进入「学习计划」页，输入「JavaScript 闭包」，展示生成的知识路线节点
